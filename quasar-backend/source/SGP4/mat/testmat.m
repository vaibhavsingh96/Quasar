...
%         // input 2-line element set file
    ...
    if (typerun == 'c')
        ...
        if (typerun == 'v')
            ...
            datefile = fopen('date.txt','wt');
            hrfile = fopen('hr.txt','wt');
            minutefile = fopen('minute.txt','wt');
            secondfile = fopen('second.txt','wt');
            vectorfile = fopen('pos_vector.txt','wt');
        end
    end
            ...
            while ((tsince < stopmfe) && (satrec.error == 0))
                ...
                if (satrec.error == 0)
                    if ((typerun ~= 'v') && (typerun ~= 'c'))
                        ...
                        fprintf(outfile,...
                            ' %16.8f %16.8f %16.8f %16.8f %12.9f %12.9f %12.9f %5i%3i%3i %2i:%2i:%9.6f %16.8f%16.8f%16.8f%12.9f%12.9f%12.9f\n',...
                            tsince,ro(1),ro(2),ro(3),vo(1),vo(2),vo(3),year,mon,day,hr,minute,sec );
                        fprintf(outfile,'\n');
                        fprintf(datefile,'%16.8f\n',day);
                        fprintf(hrfile,'%12.9f\n',hr);
                        fprintf(minutefile,'%12.9f\n',minute);
                        fprintf(secondfile,'%12.9f\n',sec);
                        fprintf(vectorfile,'%16.8f %16.8f %16.8f\n',ro(1),ro(2),ro(3));
                    else
                        jd = satrec.jdsatepoch + tsince/1440.0;
                        [year,mon,day,hr,minute,sec] = invjday ( jd );
